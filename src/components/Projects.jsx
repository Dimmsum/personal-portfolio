                  ...
                  <div className="mt-6 flex flex-wrap gap-3">
                    {activeProject.liveUrl && activeProject.liveUrl !== "#" && (
                      <a
                        ...
                        className="inline-flex items-center rounded-lg bg-navy-950 px-4 py-2.5 text-sm font-semibold text-white hover:bg-navy-900 transition-colors"
                      >
                        View Live
                      </a>
                    )}
                    {activeProject.githubUrl && activeProject.githubUrl !== "#" && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center rounded-lg border-2 border-navy-950 px-4 py-2.5 text-sm font-semibold text-navy-950 hover:bg-navy-950 hover:text-white transition-colors"
                      >
                        GitHub
                      </a>
                    )}
