...
const links = [
  ...
  { key: "tiktok", href: contact.tiktok, label: "TikTok" },
  { key: "instagram", href: contact.instagram, label: "Instagram" },
  { key: "mail", href: `mailto:${contact.email}`, label: "Email" },
];
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-4 text-lg text-navy-600 max-w-2xl mx-auto">
            Open to opportunities. Let's connect—whether you're hiring,
            collaborating, or just want to say hi.
          </p>
