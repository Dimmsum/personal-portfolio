...
export const resume = {
  ...
  summary:
    "Software Engineer with experience building full-stack applications, RESTful APIs, and cross-platform mobile apps. Passionate about creating scalable solutions and delivering user-friendly experiences across web and mobile.",
  ...
  experience: [
    {
      ...
      location: "Kingston",
      description:
        "Contributing to software development initiatives in an agile environment.",
    },
    {
    ...
    },
    {
      ...
      location: "Kingston, Jamaica",
      description:
        "Fixed a responsive web application with Angular, SCSS, and Bootstrap, supporting a university population of 12,000+ students. Developed and optimized the accompanying cross-platform mobile application using Ionic Framework, delivering a modern and consistent UI/UX across devices. Refactored layouts to resolve scaling and responsiveness issues, improving usability and accessibility.",
    },
  ],
  ...
  education: [
    {
      ...
      location: "Kingston, Jamaica",
      coursework:
        "Database Design, Object Oriented Programming, Web Programming, Programming in Python, Data Structures",
    },
  ],
